...
from bokeh.models import ColumnDataSource, Select, HoverTool, DateRangeSlider
...
# set up layout
widgets = row(ticker, range_slider)
layout = column(widgets, p, p2, sizing_mode="stretch_width")
...
# bokeh serve --show C:\Users\mauri\github\Automatic-Financial-Analysis\bokeh_app_test.py
